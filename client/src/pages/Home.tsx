...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-wrap gap-4 justify-center pt-4">
              <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 text-lg rounded-xl flex items-center gap-2 transition-all"
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Enterprise Integration", desc: "Seamlessly integrate AI with your existing SAP systems and data.", icon: Sparkles, color: "bg-blue-50 text-blue-600" },
              { title: "Governance & Security", desc: "Built-in compliance and security for enterprise-grade AI.", icon: ShieldCheck, color: "bg-indigo-50 text-indigo-600" },
              { title: "Business Context", desc: "Leverage your business data to create contextual AI solutions.", icon: Database, color: "bg-slate-50 text-slate-600" },
            ].map((item, idx) => (
              <div key={idx} className="p-6 rounded-2xl border border-slate-100 hover:border-blue-200 transition-all">
      ...
      {/* Tutorials Section - Condensed Grid */}
      <section id="tutorials" className="py-16 bg-slate-50/50 border-y border-slate-100">
        <div className="container">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Hands-On Tutorials</h2>
              <p className="text-slate-600">Practical guides covering everything from basics to advanced topics.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tutorials.map((tutorial) => {
              ...
              return (
                <Card key={tutorial.id} className="group border-slate-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300 flex flex-col">
                  <CardContent className="p-6 flex flex-col h-full">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                      <div className="flex gap-2">
                        <span className="px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 text-[10px] font-bold uppercase">{tutorial.difficulty}</span>
                        <span className="px-2 py-0.5 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold uppercase">{tutorial.duration}</span>
                      </div>
                      <Button asChild variant="ghost" size="sm" className="text-blue-600 hover:text-blue-700 font-bold p-0">
      ...
      <section id="resources" className="py-16 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-10">
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Resources & Links</h2>
            <p className="text-slate-600">Official documentation and community resources.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <a key={i} href={res.link} target="_blank" rel="noreferrer" className="p-6 rounded-xl border border-slate-100 hover:border-blue-200 hover:bg-slate-50 transition-all group">
                <h3 className="text-lg font-bold text-slate-900 mb-1 group-hover:text-blue-600">{res.title}</h3>
