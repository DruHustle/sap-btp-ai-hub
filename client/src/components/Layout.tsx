          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="https://x.com/DruHustle" target="_blank" rel="noreferrer" className="hover:text-primary">Twitter</a></li>
                <li><a href="www.linkedin.com/in/andrew-gotora-72966068" target="_blank" rel="noreferrer" className="hover:text-primary">LinkedIn</a></li>
              </ul>
            </div>
          </div>
